<!--
    ...
    Functionality: interface for manager to assign chosen salesrep to a region
    Author: Qingyu WANG
        ...
        <div class="container">
            ...
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <h1 align="center">Modify salesrep's region</h1><br>
                    <form role="form">
                        ...
                        <div class="form-group">
                            <label for="salesrep-region">Region</label><br>
                            <select class="form-control selectpicker" id="salesrep-region" name="salesrep-region">
                        ...
                        <div class="form-group">
							...
							<input class="button" id="modify-region-botton" name="modify-region-botton" type="button" value="Modify region">
						</div>
                    </form>
                </div>
            </div>
